...
|---|---|---|---|---|---|
| `REQ-AUTH-001` | `decisions/INIT-2026-000-ADR-0001-storage.md` | `openapi.yaml#/paths/~1api-keys/post` | `schemas/api-key.schema.json` | `tests/api/api-keys.spec.ts::REQ-AUTH-001` | — |
