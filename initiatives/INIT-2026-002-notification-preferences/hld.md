...
# HLD: INIT-2026-002-notification-preferences
...
```mermaid
C4Context
    title Context: INIT-2026-002-notification-preferences
...
```mermaid
C4Container
    title Containers: INIT-2026-002-notification-preferences
...
|---|---|---|---|---|
| 1 | {…} | {ФИО} | 2026-04-10 | {открыт / закрыт} |
