...
| ID | Инициатива | Статус |
|---|---|---|
| INIT-2026-000 | api-key-management | active |
| INIT-2026-001 | ontology-demo | active |
| INIT-2026-002 | notification-preferences | active |
| INIT-2026-003 | audit-log | active |
| INIT-2026-004 | adoption-path | active |
| INIT-2026-005 | multi-agent-portability | active |
| INIT-2026-006 | smart-discovery | active |
| INIT-2026-007 | quality-augmentation | active |
| INIT-2026-008 | contracts-graduation | infra-only (no L3 folder — framework enhancement commit `880299a`) |
