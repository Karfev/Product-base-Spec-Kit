<!-- FILE: design.md -->
# Design: INIT-2026-005-multi-agent-portability
...
```mermaid
C4Context
  title Context: INIT-2026-005-multi-agent-portability
...
- {Q1} (owner: @{name}, due: 2026-04-11)
- {Q2} (owner: @{name}, due: 2026-04-11)
