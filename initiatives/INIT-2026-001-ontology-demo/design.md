...
_Machine-readable source of truth: `subsystem-classification.yaml`_

| Тип | Описание | Статус | Ссылка |
|-----|----------|--------|--------|
| Д-1 | Внешнее взаимодействие деятельности | заполнено | [→ раздел](#д-1-внешнее-взаимодействие-деятельности) |
| Д-2 | Внутреннее взаимодействие деятельности | н/п | — |
| Д-3 | Внешние потоки данных деятельности | заполнено | [→ раздел](#д-3-внешние-потоки-данных-деятельности) |
...
| П-1 | Внешнее взаимодействие подсистемы | заполнено | [→ раздел](#п-1-внешнее-взаимодействие-подсистемы) |
| П-2 | Внутреннее взаимодействие компонентов | н/п | — |
| Т-1 | Схема типов и связей узлов | заполнено | [→ раздел](#т-1-схема-типов-и-связей-узлов) |
