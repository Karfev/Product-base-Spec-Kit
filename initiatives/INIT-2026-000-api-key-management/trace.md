...
|---|---|---|---|---|---|---|
| `REQ-AUTH-001` | P0 | `decisions/INIT-2026-000-ADR-0001-storage.md` | `contracts/openapi.yaml#/paths/~1api-keys/post` | `contracts/schemas/api-key.schema.json` | `tests/api/api-keys.spec.ts::REQ-AUTH-001` | — |
